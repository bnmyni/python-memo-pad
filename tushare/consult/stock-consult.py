...
rzrqjyzl:本日融资融券余额(元)
调用方法：
print(ts.sh_margins(start='2018-01-01', end='2015-01-16'))
...
rqchl: 本日融券偿还量
调用方法：
print(ts.sh_margin_details(start='2017-01-01', end='2018-04-19', symbol='601989'))
